...
import { ChevronDown, ArrowRight, Zap, Brain, Sparkles, BarChart3, Clock } from "lucide-react";
      ...
      <div className="min-h-screen">
        ...
        <section className="relative min-h-screen flex items-center justify-center bg-black overflow-hidden pt-24">
          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            >
              {/* Badge */}
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 mb-12 md:mb-8">
              ...
              {/* Subtítulo */}
              <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mb-12 md:mb-10">
              ...
              {/* Cards de Benefícios */}
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 md:mb-10">
              ...
              {/* Frase Destacada */}
              <div className="max-w-3xl mx-auto mb-12 md:mb-10 flex items-center">
        ...
        <section id="produtos-servicos" className="py-24 bg-black relative overflow-hidden scroll-mt-20">
          {/* Glow de fundo */}
          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            {/* Cards dos Produtos */}
            {/* Removed Ugarit Synapse and Ugarit Machina cards as per user request */}
        ...
        <section className="py-24 bg-black relative overflow-hidden">
          <div className="container mx-auto px-4 sm:px-6 relative z-10">
            <div className="flex justify-center mb-12">
              <div className="inline-flex items-center px-4 py-2 rounded-full border neon-border">
                <span className="mr-2 flex items-center">
                  <Clock className="w-5 h-5 text-[#00f0ff] drop-shadow-[0_0_8px_#00f0ff] animate-pulse" strokeWidth={2.2} />
                </span>
                <span className="text-sm text-white/90">Como entregamos resultado</span>
              </div>
            </div>
