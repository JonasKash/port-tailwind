...
export default function Parceiros() {
  ...
  return (
    <div className="min-h-screen bg-black">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() => document.getElementById('programa-afiliacao').scrollIntoView({ behavior: 'smooth' })}
      ...
      <section id="programa-afiliacao" className="py-32 bg-black relative">
          ...
          >
            ...
            <div className="relative z-10 text-center">
              ...
              <p className="text-xl text-gray-300 leading-relaxed max-w-3xl mx-auto">
                Você indica tudo que acredita.
              </p>
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                onClick={() => window.open('https://wa.me/5516996235750?text=Ol%C3%A1%20Bruno%2C%20quero%20virar%20afiliado%20de%20voc%C3%AAs%21', '_blank')}
                className="px-8 py-4 bg-gradient-to-r from-[#00f0ff] to-[#9442fe] text-black font-bold rounded-full text-lg mt-8"
              >
                Quero ser afiliado
                <ArrowRight className="inline-block ml-2 w-6 h-6" />
              </motion.button>
